    ...
    function traverse(node, parent) {
        switch (node.type) {
            case 'Element': {
                ...
                code.create.push(
                    `${variableName} = should_hydrate ? ${hydration_parent}.childNodes[${hydration_index++}] : document.createElement('${node.name}');`
                )
                ...
                code.create.push(`if(!should_hydrate) ${parent}.appendChild(${variableName})`);
            ...
            case 'Text': {
                ...
                code.variables.push(variableName);
                code.create.push(
                    `${variableName} = should_hydrate ? ${hydration_parent}.childNodes[${hydration_index++}] : document.createTextNode('${node.value}')`
                );
                hydration_index++;
                code.create.push(`if (!should_hydrate) ${parent}.appendChild(${variableName})`);
                break;
